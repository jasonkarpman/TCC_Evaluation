...
#Define counties and years
Counties <- c("Fresno County",
              "Los Angeles County", 
              "San Bernardino County",
              "San Joaquin County")
years <- 2016:2021

#check variable name changes overtime
acs_vars <- load_variables(2021,"acs5",cache=TRUE)
acs_vars_p <- load_variables(2021,"acs5/profile",cache=TRUE)
acs_vars_s <- load_variables(2021,"acs5/subject",cache=TRUE)
...
Vars1_1 <- c("B03002_001E", "B03002_001M",
...
Vars1_2 <- c("B03002_001E", "B03002_001M",
             "B03002_012E", "B03002_012M",
             "B03002_003E", "B03002_003M",
             "B03002_004E", "B03002_004M",
             "B03002_006E", "B03002_006M",
             ...
             "B05006_047E", "B05006_047M",
             "B05006_091E", "B05006_091M",
             "B05006_130E", "B05006_130M")

####################################################
####################################################
#Latin American Born variable name change over time
#2021 - B05006_130
#2020 - B05006_130
#2019 - B05006_130
#2018 - B05006_124
...
#see Page 11 in: https://www2.census.gov/programs-surveys/acs/tech_docs/accuracy/MultiyearACSAccuracyofData2018.pdf? 
...
for (i in 2019:2021){
  ...
  Pop_i_output3$bornAf_per_moe <- moe_prop(Pop_i_output3$B05006_091_sumest, 
                                           ...
                                           Pop_i_output3$B05006_091_summoe, 
                                           Pop_i_output3$B03002_001_summoe)*100
  Pop_i_output3$bornLA_per <- Pop_i_output3$B05006_130_sumest / Pop_i_output3$B03002_001_sumest * 100
  Pop_i_output3$bornLA_per_moe <- moe_prop(Pop_i_output3$B05006_130_sumest, 
                                           Pop_i_output3$B03002_001_sumest,
                                           Pop_i_output3$B05006_130_summoe, 
                                           Pop_i_output3$B03002_001_summoe)*100
  Pop_i_output4 <- Pop_i_output3[c("group",
                                   "B03002_001_sumest", "B03002_001_summoe",
                                   "Hisp_per", "Hisp_per_moe",
  ...
  Pop_i_county_output3$bornAf_per_moe <- moe_prop(Pop_i_county_output3$B05006_091_sumest, 
                                                  ...
                                                  Pop_i_county_output3$B05006_091_summoe, 
                                                  Pop_i_county_output3$B03002_001_summoe)*100
  Pop_i_county_output3$bornLA_per <- Pop_i_county_output3$B05006_130_sumest / Pop_i_county_output3$B03002_001_sumest * 100
  Pop_i_county_output3$bornLA_per_moe <- moe_prop(Pop_i_county_output3$B05006_130_sumest, 
                                                  Pop_i_county_output3$B03002_001_sumest,
                                                  Pop_i_county_output3$B05006_130_summoe, 
                                                  Pop_i_county_output3$B03002_001_summoe)*100
  Pop_i_county_output4 <- Pop_i_county_output3[c("group",
                                                 "B03002_001_sumest", "B03002_001_summoe",
                                                 "Hisp_per", "Hisp_per_moe",
  ...
  Pop_i_state_output3$bornAf_per_moe <- moe_prop(Pop_i_state_output3$B05006_091_sumest, 
                                                 ...
                                                 Pop_i_state_output3$B05006_091_summoe, 
                                                 Pop_i_state_output3$B03002_001_summoe)*100
  Pop_i_state_output3$bornLA_per <- Pop_i_state_output3$B05006_130_sumest / Pop_i_state_output3$B03002_001_sumest * 100
  Pop_i_state_output3$bornLA_per_moe <- moe_prop(Pop_i_state_output3$B05006_130_sumest, 
                                                 Pop_i_state_output3$B03002_001_sumest,
                                                 Pop_i_state_output3$B05006_130_summoe, 
                                                 Pop_i_state_output3$B03002_001_summoe)*100
  Pop_i_state_output4 <- Pop_i_state_output3[c("group",
                                               "B03002_001_sumest", "B03002_001_summoe",
                                               "Hisp_per", "Hisp_per_moe",
...
#variable name change in 2019 & 2020
Vars2_3_1 <- c("DP02_0059E", "DP02_0059M",
               "DP02_0060E", "DP02_0060M",
               "DP02_0061E", "DP02_0061M",
               "DP02_0065E", "DP02_0065M",
               "DP02_0066E", "DP02_0066M")
...
Econ_ed_i_input1 <- Econ_ed_i_input %>%
                     mutate(var = gsub("DP02_0060", "ed_belowhs", var)) %>%
                     mutate(var = gsub("DP02_0061", "ed_belowhs", var)) %>%
                     mutate(var = gsub("DP02_0065", "ed_aboveba", var)) %>%
                     mutate(var = gsub("DP02_0066", "ed_aboveba", var)) 
...
Econ_ed_i_output1 <- dcast(melt(Econ_ed_i_output, id.vars=1:2), 
                           group ~ var + variable, fun.aggregate = sum)
Econ_ed_i_output1$ed_belowhs_per <- Econ_ed_i_output1$ed_belowhs_sumest / Econ_ed_i_output1$DP02_0059_sumest * 100
Econ_ed_i_output1$ed_belowhs_per_moe <- moe_prop(Econ_ed_i_output1$ed_belowhs_sumest,
                                                 Econ_ed_i_output1$DP02_0059_sumest,
                                                 Econ_ed_i_output1$ed_belowhs_summoe,
                                                 Econ_ed_i_output1$DP02_0059_summoe)*100
Econ_ed_i_output1$ed_aboveba_per <- Econ_ed_i_output1$ed_aboveba_sumest / Econ_ed_i_output1$DP02_0059_sumest * 100
Econ_ed_i_output1$ed_aboveba_per_moe <- moe_prop(Econ_ed_i_output1$ed_aboveba_sumest,
                                                 Econ_ed_i_output1$DP02_0059_sumest,
                                                 Econ_ed_i_output1$ed_aboveba_summoe,
                                                 Econ_ed_i_output1$DP02_0059_summoe)*100
...
Econ_ed_i_county_output1 <- dcast(melt(Econ_ed_i_county_output, id.vars=1:2), 
                                  group ~ var + variable, fun.aggregate = sum)
Econ_ed_i_county_output1$ed_belowhs_per <- Econ_ed_i_county_output1$ed_belowhs_sumest / Econ_ed_i_county_output1$DP02_0059_sumest * 100
Econ_ed_i_county_output1$ed_belowhs_per_moe <- moe_prop(Econ_ed_i_county_output1$ed_belowhs_sumest,
                                                        Econ_ed_i_county_output1$DP02_0059_sumest,
                                                        Econ_ed_i_county_output1$ed_belowhs_summoe,
                                                        Econ_ed_i_county_output1$DP02_0059_summoe)*100
Econ_ed_i_county_output1$ed_aboveba_per <- Econ_ed_i_county_output1$ed_aboveba_sumest / Econ_ed_i_county_output1$DP02_0059_sumest * 100
Econ_ed_i_county_output1$ed_aboveba_per_moe <- moe_prop(Econ_ed_i_county_output1$ed_aboveba_sumest,
                                                        Econ_ed_i_county_output1$DP02_0059_sumest,
                                                        Econ_ed_i_county_output1$ed_aboveba_summoe,
                                                        Econ_ed_i_county_output1$DP02_0059_summoe)*100
...
Econ_ed_i_state_output1 <- dcast(melt(Econ_ed_i_state_output, id.vars=1:2), 
                                  group ~ var + variable, fun.aggregate = sum)
Econ_ed_i_state_output1$ed_belowhs_per <- Econ_ed_i_state_output1$ed_belowhs_sumest / Econ_ed_i_state_output1$DP02_0059_sumest * 100
Econ_ed_i_state_output1$ed_belowhs_per_moe <- moe_prop(Econ_ed_i_state_output1$ed_belowhs_sumest,
                                                        Econ_ed_i_state_output1$DP02_0059_sumest,
                                                        Econ_ed_i_state_output1$ed_belowhs_summoe,
                                                        Econ_ed_i_state_output1$DP02_0059_summoe)*100
Econ_ed_i_state_output1$ed_aboveba_per <- Econ_ed_i_state_output1$ed_aboveba_sumest / Econ_ed_i_state_output1$DP02_0059_sumest * 100
Econ_ed_i_state_output1$ed_aboveba_per_moe <- moe_prop(Econ_ed_i_state_output1$ed_aboveba_sumest,
                                                        Econ_ed_i_state_output1$DP02_0059_sumest,
                                                        Econ_ed_i_state_output1$ed_aboveba_summoe,
                                                        Econ_ed_i_state_output1$DP02_0059_summoe)*100
...
#define variables needed
#2013-2014 variables are different from 2015 and beyond, data structure has changed overtime. 
...
Vars5 <- c("B25003_001E", "B25003_001M",
           ...
           "B25003A_002E", "B25003A_002M",
           "B25003B_002E", "B25003B_002M",
           "B25003C_002E", "B25003C_002M",
           "B25003D_002E", "B25003D_002M",
           "B25003E_002E", "B25003E_002M",
           "B25003F_002E", "B25003F_002M",
           "B25003G_002E", "B25003G_002M",
           "B25003H_002E", "B25003H_002M",
           "B25003I_002E", "B25003I_002M",
...
Hous_i_input1 <- Hous_i_input %>%
                     ...
                     mutate(var = gsub("B25091_011", "hhs_mort30plus", var)) %>%
...
Hous_i_output1$tenure_owner_per_moe <- moe_prop(Hous_i_output1$B25003_002_sumest,
                                                ...
                                                Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_white_per <- Hous_i_output1$B25003A_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_white_per_moe <- moe_prop(Hous_i_output1$B25003A_002_sumest,
                                                      Hous_i_output1$B25003_001_sumest,
                                                      Hous_i_output1$B25003A_002_summoe,
                                                      Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_black_per <- Hous_i_output1$B25003B_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_black_per_moe <- moe_prop(Hous_i_output1$B25003B_002_sumest,
                                                      Hous_i_output1$B25003_001_sumest,
                                                      Hous_i_output1$B25003B_002_summoe,
                                                      Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_AI_per <- Hous_i_output1$B25003C_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_AI_per_moe <- moe_prop(Hous_i_output1$B25003C_002_sumest,
                                                   Hous_i_output1$B25003_001_sumest,
                                                   Hous_i_output1$B25003C_002_summoe,
                                                   Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_asian_per <- Hous_i_output1$B25003D_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_asian_per_moe <- moe_prop(Hous_i_output1$B25003D_002_sumest,
                                                      Hous_i_output1$B25003_001_sumest,
                                                      Hous_i_output1$B25003D_002_summoe,
                                                      Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_PI_per <- Hous_i_output1$B25003E_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_PI_per_moe <- moe_prop(Hous_i_output1$B25003E_002_sumest,
                                                   Hous_i_output1$B25003_001_sumest,
                                                   Hous_i_output1$B25003E_002_summoe,
                                                   Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_other_per <- Hous_i_output1$B25003F_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_other_per_moe <- moe_prop(Hous_i_output1$B25003F_002_sumest,
                                                      Hous_i_output1$B25003_001_sumest,
                                                      Hous_i_output1$B25003F_002_summoe,
                                                      Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_tworaces_per <- Hous_i_output1$B25003G_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_tworaces_per_moe <- moe_prop(Hous_i_output1$B25003G_002_sumest,
                                                         Hous_i_output1$B25003_001_sumest,
                                                         Hous_i_output1$B25003G_002_summoe,
                                                         Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_nonhispanic_white_per <- Hous_i_output1$B25003H_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_nonhispanic_white_per_moe <- moe_prop(Hous_i_output1$B25003H_002_sumest,
                                                                  Hous_i_output1$B25003_001_sumest,
                                                                  Hous_i_output1$B25003H_002_summoe,
                                                                  Hous_i_output1$B25003_001_summoe)*100
Hous_i_output1$tenure_owner_hispanic_per <- Hous_i_output1$B25003I_002_sumest / Hous_i_output1$B25003_001_sumest * 100
Hous_i_output1$tenure_owner_hispanic_per_moe <- moe_prop(Hous_i_output1$B25003I_002_sumest,
                                                         Hous_i_output1$B25003_001_sumest,
                                                         Hous_i_output1$B25003I_002_summoe,
                                                         Hous_i_output1$B25003_001_summoe)*100
...
Hous_i_output1$tenure_vacant_sale_per_moe <- moe_prop(Hous_i_output1$B25004_004_sumest,
                                                      ...
                                                      Hous_i_output1$B25002_001_summoe)*100
Hous_i_output1$hhs_total <- Hous_i_output1$B11001_001_sumest
Hous_i_output1$hhs_total_moe <- Hous_i_output1$B11001_001_summoe
Hous_i_output1$hhs_size_ave <- Hous_i_output1$B09019_002_sumest / Hous_i_output1$B11001_001_sumest
Hous_i_output1$hhs_size_ave_moe <- moe_prop(Hous_i_output1$B09019_002_sumest,
                                            Hous_i_output1$B11001_001_sumest,
                                            Hous_i_output1$B09019_002_summoe,
                                            Hous_i_output1$B11001_001_summoe)
Hous_i_output2 <- Hous_i_output1[c("group","tenure_renter_per", "tenure_renter_per_moe",
                                   "tenure_owner_per", "tenure_owner_per_moe",
                                   "tenure_owner_white_per", "tenure_owner_white_per_moe",
                                   "tenure_owner_black_per", "tenure_owner_black_per_moe",
                                   "tenure_owner_AI_per", "tenure_owner_AI_per_moe",
                                   "tenure_owner_asian_per", "tenure_owner_asian_per_moe",
                                   "tenure_owner_PI_per", "tenure_owner_PI_per_moe",
                                   "tenure_owner_other_per", "tenure_owner_other_per_moe",
                                   "tenure_owner_tworaces_per", "tenure_owner_tworaces_per_moe",
                                   "tenure_owner_nonhispanic_white_per", "tenure_owner_nonhispanic_white_per_moe",
                                   "tenure_owner_hispanic_per", "tenure_owner_hispanic_per_moe",
                                   ...
                                   "hhs_total", "hhs_total_moe", "hhs_size_ave", "hhs_size_ave_moe")]
...
Hous_i_county_output1$tenure_owner_per_moe <- moe_prop(Hous_i_county_output1$B25003_002_sumest,
                                                       ...
                                                       Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_white_per <- Hous_i_county_output1$B25003A_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_white_per_moe <- moe_prop(Hous_i_county_output1$B25003A_002_sumest,
                                                      Hous_i_county_output1$B25003_001_sumest,
                                                      Hous_i_county_output1$B25003A_002_summoe,
                                                      Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_black_per <- Hous_i_county_output1$B25003B_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_black_per_moe <- moe_prop(Hous_i_county_output1$B25003B_002_sumest,
                                                      Hous_i_county_output1$B25003_001_sumest,
                                                      Hous_i_county_output1$B25003B_002_summoe,
                                                      Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_AI_per <- Hous_i_county_output1$B25003C_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_AI_per_moe <- moe_prop(Hous_i_county_output1$B25003C_002_sumest,
                                                   Hous_i_county_output1$B25003_001_sumest,
                                                   Hous_i_county_output1$B25003C_002_summoe,
                                                   Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_asian_per <- Hous_i_county_output1$B25003D_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_asian_per_moe <- moe_prop(Hous_i_county_output1$B25003D_002_sumest,
                                                      Hous_i_county_output1$B25003_001_sumest,
                                                      Hous_i_county_output1$B25003D_002_summoe,
                                                      Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_PI_per <- Hous_i_county_output1$B25003E_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_PI_per_moe <- moe_prop(Hous_i_county_output1$B25003E_002_sumest,
                                                   Hous_i_county_output1$B25003_001_sumest,
                                                   Hous_i_county_output1$B25003E_002_summoe,
                                                   Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_other_per <- Hous_i_county_output1$B25003F_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_other_per_moe <- moe_prop(Hous_i_county_output1$B25003F_002_sumest,
                                                      Hous_i_county_output1$B25003_001_sumest,
                                                      Hous_i_county_output1$B25003F_002_summoe,
                                                      Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_tworaces_per <- Hous_i_county_output1$B25003G_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_tworaces_per_moe <- moe_prop(Hous_i_county_output1$B25003G_002_sumest,
                                                         Hous_i_county_output1$B25003_001_sumest,
                                                         Hous_i_county_output1$B25003G_002_summoe,
                                                         Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_nonhispanic_white_per <- Hous_i_county_output1$B25003H_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_nonhispanic_white_per_moe <- moe_prop(Hous_i_county_output1$B25003H_002_sumest,
                                                                  Hous_i_county_output1$B25003_001_sumest,
                                                                  Hous_i_county_output1$B25003H_002_summoe,
                                                                  Hous_i_county_output1$B25003_001_summoe)*100
Hous_i_county_output1$tenure_owner_hispanic_per <- Hous_i_county_output1$B25003I_002_sumest / Hous_i_county_output1$B25003_001_sumest * 100
Hous_i_county_output1$tenure_owner_hispanic_per_moe <- moe_prop(Hous_i_county_output1$B25003I_002_sumest,
                                                         Hous_i_county_output1$B25003_001_sumest,
                                                         Hous_i_county_output1$B25003I_002_summoe,
                                                         Hous_i_county_output1$B25003_001_summoe)*100
...
Hous_i_county_output1$tenure_vacant_sale_per_moe <- moe_prop(Hous_i_county_output1$B25004_004_sumest,
                                                             ...
                                                             Hous_i_county_output1$B25002_001_summoe)*100
Hous_i_county_output1$hhs_total <- Hous_i_county_output1$B11001_001_sumest
Hous_i_county_output1$hhs_total_moe <- Hous_i_county_output1$B11001_001_summoe
Hous_i_county_output1$hhs_size_ave <- Hous_i_county_output1$B09019_002_sumest / Hous_i_county_output1$B11001_001_sumest
Hous_i_county_output1$hhs_size_ave_moe <- moe_prop(Hous_i_county_output1$B09019_002_sumest,
                                            Hous_i_county_output1$B11001_001_sumest,
                                            Hous_i_county_output1$B09019_002_summoe,
                                            Hous_i_county_output1$B11001_001_summoe)
...
Hous_i_state_output1$tenure_owner_per_moe <- moe_prop(Hous_i_state_output1$B25003_002_sumest,
                                                      ...
                                                      Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_white_per <- Hous_i_state_output1$B25003A_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_white_per_moe <- moe_prop(Hous_i_state_output1$B25003A_002_sumest,
                                                             Hous_i_state_output1$B25003_001_sumest,
                                                             Hous_i_state_output1$B25003A_002_summoe,
                                                             Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_black_per <- Hous_i_state_output1$B25003B_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_black_per_moe <- moe_prop(Hous_i_state_output1$B25003B_002_sumest,
                                                             Hous_i_state_output1$B25003_001_sumest,
                                                             Hous_i_state_output1$B25003B_002_summoe,
                                                             Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_AI_per <- Hous_i_state_output1$B25003C_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_AI_per_moe <- moe_prop(Hous_i_state_output1$B25003C_002_sumest,
                                                          Hous_i_state_output1$B25003_001_sumest,
                                                          Hous_i_state_output1$B25003C_002_summoe,
                                                          Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_asian_per <- Hous_i_state_output1$B25003D_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_asian_per_moe <- moe_prop(Hous_i_state_output1$B25003D_002_sumest,
                                                             Hous_i_state_output1$B25003_001_sumest,
                                                             Hous_i_state_output1$B25003D_002_summoe,
                                                             Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_PI_per <- Hous_i_state_output1$B25003E_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_PI_per_moe <- moe_prop(Hous_i_state_output1$B25003E_002_sumest,
                                                          Hous_i_state_output1$B25003_001_sumest,
                                                          Hous_i_state_output1$B25003E_002_summoe,
                                                          Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_other_per <- Hous_i_state_output1$B25003F_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_other_per_moe <- moe_prop(Hous_i_state_output1$B25003F_002_sumest,
                                                             Hous_i_state_output1$B25003_001_sumest,
                                                             Hous_i_state_output1$B25003F_002_summoe,
                                                             Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_tworaces_per <- Hous_i_state_output1$B25003G_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_tworaces_per_moe <- moe_prop(Hous_i_state_output1$B25003G_002_sumest,
                                                                Hous_i_state_output1$B25003_001_sumest,
                                                                Hous_i_state_output1$B25003G_002_summoe,
                                                                Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_nonhispanic_white_per <- Hous_i_state_output1$B25003H_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_nonhispanic_white_per_moe <- moe_prop(Hous_i_state_output1$B25003H_002_sumest,
                                                                         Hous_i_state_output1$B25003_001_sumest,
                                                                         Hous_i_state_output1$B25003H_002_summoe,
                                                                         Hous_i_state_output1$B25003_001_summoe)*100
Hous_i_state_output1$tenure_owner_hispanic_per <- Hous_i_state_output1$B25003I_002_sumest / Hous_i_state_output1$B25003_001_sumest * 100
Hous_i_state_output1$tenure_owner_hispanic_per_moe <- moe_prop(Hous_i_state_output1$B25003I_002_sumest,
                                                                Hous_i_state_output1$B25003_001_sumest,
                                                                Hous_i_state_output1$B25003I_002_summoe,
                                                                Hous_i_state_output1$B25003_001_summoe)*100
...
Hous_i_state_output1$tenure_vacant_sale_per_moe <- moe_prop(Hous_i_state_output1$B25004_004_sumest,
                                                            ...
                                                            Hous_i_state_output1$B25002_001_summoe)*100
Hous_i_state_output1$hhs_total <- Hous_i_state_output1$B11001_001_sumest
Hous_i_state_output1$hhs_total_moe <- Hous_i_state_output1$B11001_001_summoe
Hous_i_state_output1$hhs_size_ave <- Hous_i_state_output1$B09019_002_sumest / Hous_i_state_output1$B11001_001_sumest
Hous_i_state_output1$hhs_size_ave_moe <- moe_prop(Hous_i_state_output1$B09019_002_sumest,
                                            Hous_i_state_output1$B11001_001_sumest,
                                            Hous_i_state_output1$B09019_002_summoe,
                                            Hous_i_state_output1$B11001_001_summoe)
...
Vars6 <- c("B08201_001E", "B08201_001M",
           ...
           "B08201_004E", "B08201_004M",
           "B08201_005E", "B08201_005M",
           "B08201_006E", "B08201_006M",
...
Tran_i_input1 <- Tran_i_input %>%
                     mutate(var = gsub("B08301_016|B08301_017|B08301_020", "commute_other", var),
                            var = gsub("B08201_003|B08201_004|B08201_005|B08201_006", "plus1veh", var))
...
Tran_i_output1 <- dcast(melt(Tran_i_output, id.vars=1:2), 
                        group ~ var + variable, fun.aggregate = sum)
Tran_i_output1$hhs_plus1veh_per <- Tran_i_output1$plus1veh_sumest / Tran_i_output1$plus1veh_sumest * 100
Tran_i_output1$hhs_plus1veh_per_moe <- moe_prop(Tran_i_output1$plus1veh_sumest,
                                            Tran_i_output1$B08201_001_sumest,
                                            Tran_i_output1$plus1veh_summoe,
...
Tran_i_output1$commute_bike_per_moe <- moe_prop(Tran_i_output1$B08301_018_sumest,
                                                ...
                                                Tran_i_output1$B08301_001_summoe)*100
Tran_i_output1$commute_wfh_per <- Tran_i_output1$B08301_021_sumest / Tran_i_output1$B08301_001_sumest * 100
Tran_i_output1$commute_wfh_per_moe <- moe_prop(Tran_i_output1$B08301_021_sumest,
                                                Tran_i_output1$B08301_001_sumest,
                                                Tran_i_output1$B08301_021_summoe,
                                                Tran_i_output1$B08301_001_summoe)*100
...
Tran_i_output1$commute_other_per_moe <- moe_prop(Tran_i_output1$commute_other_sumest,
                                                 ...
                                                 Tran_i_output1$B08301_001_summoe)*100
Tran_i_output2 <- Tran_i_output1[c("group","hhs_plus1veh_per", "hhs_plus1veh_per_moe",
                                   ...
                                   "commute_wfh_per", "commute_wfh_per_moe",
...
Tran_i_county_output1 <- dcast(melt(Tran_i_county_output, id.vars=1:2), 
                               group ~ var + variable, fun.aggregate = sum)
Tran_i_county_output1$hhs_plus1veh_per <- Tran_i_county_output1$plus1veh_sumest / Tran_i_county_output1$B08201_001_sumest * 100
Tran_i_county_output1$hhs_plus1veh_per_moe <- moe_prop(Tran_i_county_output1$plus1veh_sumest,
                                                   Tran_i_county_output1$B08201_001_sumest,
                                                   Tran_i_county_output1$plus1veh_summoe,
...
Tran_i_county_output1$commute_bike_per_moe <- moe_prop(Tran_i_county_output1$B08301_018_sumest,
                                                       ...
                                                       Tran_i_county_output1$B08301_001_summoe)*100
Tran_i_county_output1$commute_wfh_per <- Tran_i_county_output1$B08301_021_sumest / Tran_i_county_output1$B08301_001_sumest * 100
Tran_i_county_output1$commute_wfh_per_moe <- moe_prop(Tran_i_county_output1$B08301_021_sumest,
                                               Tran_i_county_output1$B08301_001_sumest,
                                               Tran_i_county_output1$B08301_021_summoe,
                                               Tran_i_county_output1$B08301_001_summoe)*100
...
Tran_i_county_output1$commute_other_per_moe <- moe_prop(Tran_i_county_output1$commute_other_sumest,
                                                        ...
                                                        Tran_i_county_output1$B08301_001_summoe)*100
Tran_i_county_output2 <- Tran_i_county_output1[c("group","hhs_plus1veh_per", "hhs_plus1veh_per_moe",
                                                 "commute_car_per", "commute_car_per_moe",
                                                 "commute_car_alone_per", "commute_car_alone_per_moe",
                                                 "commute_car_carpool_per", "commute_car_carpool_per_moe",
                                                 "commute_transit_per", "commute_transit_per_moe",
...
Tran_i_state_output1 <- dcast(melt(Tran_i_state_output, id.vars=1:2), 
                              group ~ var + variable, fun.aggregate = sum)
Tran_i_state_output1$hhs_plus1veh_per <- Tran_i_state_output1$plus1veh_sumest / Tran_i_state_output1$B08201_001_sumest * 100
Tran_i_state_output1$hhs_plus1veh_per_moe <- moe_prop(Tran_i_state_output1$plus1veh_sumest,
                                                  Tran_i_state_output1$B08201_001_sumest,
                                                  Tran_i_state_output1$plus1veh_summoe,
...
Tran_i_state_output1$commute_bike_per_moe <- moe_prop(Tran_i_state_output1$B08301_018_sumest,
                                                      ...
                                                      Tran_i_state_output1$B08301_001_summoe)*100
Tran_i_state_output1$commute_wfh_per <- Tran_i_state_output1$B08301_021_sumest / Tran_i_state_output1$B08301_001_sumest * 100
Tran_i_state_output1$commute_wfh_per_moe <- moe_prop(Tran_i_state_output1$B08301_021_sumest,
                                                      Tran_i_state_output1$B08301_001_sumest,
                                                      Tran_i_state_output1$B08301_021_summoe,
                                                      Tran_i_state_output1$B08301_001_summoe)*100
...
Tran_i_state_output2 <- Tran_i_state_output1[c("group","hhs_plus1veh_per", "hhs_plus1veh_per_moe",
                                               "commute_car_per", "commute_car_per_moe",
                                               "commute_car_alone_per", "commute_car_alone_per_moe",
                                               "commute_car_carpool_per", "commute_car_carpool_per_moe",
                                               "commute_transit_per", "commute_transit_per_moe",
...
TCC_results <- rbind(Dem_results, Econ_results, En_results, Hlth_results, Hous_results, Tran_results1) %>% 
               mutate(var = gsub("_moe", "", variable),
                      category = case_when(str_detect(as.character(variable), "moe") == TRUE ~ "MOE",
                                            TRUE ~ "estimate")) %>% 
               select(-variable) %>% 
               pivot_wider(names_from = category, values_from = value) %>% 
               mutate(var = factor(var, levels = c("Pop_tot", "Hisp_per", "NonHisp_whit_per", 
                                                   "NonHisp_color_all_per", "NonHisp_color_other_per",
                                                   "NonHisp_blac_per", "NonHisp_asia_per",
                                                   "NonHisp_PI_per", "NonHisp_AI_per", "NonHisp_two_per", 
                                                   "NonHisp_other_per", "bornFor_per", "bornAs_per", 
                                                   "bornAf_per", "bornLA_per","income_median", 
                                                   "hhs_125kplus_per", "poverty_per",  "ed_belowhs_per", 
                                                   "ed_aboveba_per", "emp_16plus_per","heating_elec_per", 
                                                   "heating_utilitygas_per", "heating_other_fossil_per", 
                                                   "heating_other_nonfossil_per", "heating_no_per", 
                                                   "hlth_ins_per","hlth_ins_prv_per","hlth_ins_pub_per",
                                                   "tenure_renter_per", "tenure_owner_per",
                                                   "tenure_owner_white_per", "tenure_owner_black_per",
                                                   "tenure_owner_AI_per", "tenure_owner_asian_per", 
                                                   "tenure_owner_PI_per", "tenure_owner_other_per", 
                                                   "tenure_owner_tworaces_per", "tenure_owner_nonhispanic_white_per", 
                                                   "tenure_owner_hispanic_per", 
                                                   "hhs_rent30plus_per","hhs_rent50plus_per", 
                                                   "hhs_mort30plus_per","hhs_mort50plus_per", 
                                                   "hhs_occup_1plus_per", "hhs_occup_1plus_renter_per",
                                                   "hhs_occup_1plus_owner_per",
                                                   "hhs_same1yr_owner_per", "hhs_same1yr_renter_per",
                                                   "hhs_same1yr_75kminus_per", "hhs_same1yr_75kplus_per", 
                                                   "tenure_vacant_rent_per","tenure_vacant_sale_per", 
                                                   "hhs_total", "hhs_total_moe", "hhs_size_ave", "hhs_size_ave_moe",
                                                   "hhs_plus1veh_per", "commute_car_alone_per", 
                                                   "commute_car_carpool_per", "commute_transit_per",
                                                   "commute_walk_per", "commute_bike_per","commute_wfh_per", "commute_other_per")))
 
                                                        
#Perform significance testing over time with 2016 as the base year                                                                                                               "commute_walk_per", "commute_bike_per", "commute_other_per"))
TCC_results1 <- TCC_results %>% 
                  group_by(group, var) %>% 
                  mutate(growth_per_base = (estimate - first(estimate))/first(estimate) * 100) %>%
...
TCC_results2 <- TCC_results %>% 
                filter(!group %in% c(Counties, "California")) %>% 
                separate(group, c("site", "group"), " ") %>% 
...
TCC_sig_geo <- bind_rows(TCC_results2 %>% 
                           filter(group != "Control") %>% 
                         ...
                         TCC_results4 %>% 
                           filter(group != "Control") %>% 
                           mutate(between = "Control-County"),
                         TCC_results6 %>% 
                           filter(group != "Control") %>% 
                           mutate(between = "Control-State")) %>% 
                as.data.frame() %>% 
                select(-c(group,estimate, MOE, diff)) %>% 
                arrange(site, var, year, between)

#Generate output file
write.csv(TCC_results1, file = "Sigtest_temporal_012723.csv", row.names=FALSE)
write.csv(TCC_sig_geo, file = "Sigtest_spatial_012723.csv", row.names=FALSE)
